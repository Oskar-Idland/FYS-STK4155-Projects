...
\begin{figure*}
  ...
  \includegraphics[width=0.95\textwidth]{../figs/density_new_and_old.pdf}
...
%   \vspace*{-5pt}
%   \centering %Centers the figure
%   \includegraphics[width=0.9\textwidth]{../figs/density_smoothed_surf.pdf}
%   \caption{\colorbox{magenta}{caption}}\label{fig:density smoothed surf}
%   \vspace*{-5pt}
% \end{figure*}
...
%   \vspace*{-5pt}
%   \centering %Centers the figure
%   \includegraphics[width=0.9\textwidth]{../figs/density_old_surf.pdf}
%   \caption{\colorbox{magenta}{caption}}\label{fig:density old surf}
%   \vspace*{-5pt}
% \end{figure*}
...
%   \vspace*{-5pt}
%   \centering %Centers the figure
%   \includegraphics[width=0.9\textwidth]{../figs/density_old_smoothed_surf.pdf}
%   \caption{\colorbox{magenta}{caption}}\label{fig:density old smoothed surf}
%   \vspace*{-5pt}
% \end{figure*}
...
\subsection{Alternative Expression for the OLS Cost Function}\label{subapp:cost}
\colorbox{magenta}{rewrite to fit report}
